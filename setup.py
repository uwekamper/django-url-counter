...
# -*- coding: utf-8 -*-
"""
    Setup file for django_url_counter.
...
MAIN_PACKAGE = "django_url_counter"
DESCRIPTION = "None"
LICENSE = "new BSD"
URL = "None"
AUTHOR = "Uwe Kamper"
...
# Add here console scripts like ['hello_world = django_url_counter.module:function']
CONSOLE_SCRIPTS = []
...
def setup_package():
    command_options = {
        ...
        'test': {'test_suite': ('setup.py', 'tests'),
                 'cov': ('setup.py', 'django_url_counter')}}
    if JUNIT_XML:
